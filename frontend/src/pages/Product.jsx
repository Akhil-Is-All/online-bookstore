          ...
          <div>
            ...
            <div className="flex-1">
              ...
              <button
                ...
                className="bg-black text-white px-8 py-3 text-sm active:bg-gray-700 mt-2"
              >
                ADD TO CART
              </button>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            ...
            atque numquam, quos dolores sint quae ullam ea eaque ab!
          </p>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam
            quisquam unde tempora beatae, ea perspiciatis!
          </p>
        </div>
      </div>
